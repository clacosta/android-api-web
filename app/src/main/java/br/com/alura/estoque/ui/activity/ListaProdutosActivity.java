...
public class ListaProdutosActivity extends AppCompatActivity {
    ...
    private static final String MENSAGEM_ERRO_BUSCA_PRODUTOS = "Não foi possível carregar os produtos.";
    private static final String MENSAGEM_ERRO_REMOCAO = "Não foi possível excluir o produto.";
    private static final String MENSAGEM_ERRO_INCLUSAO = "Não foi possível salvar o produto.";
    ...
    private void salva(Produto produtoCriado) {
        repository.salva(produtoCriado,
                new ProdutosRepository.DadosCarregadosCallback<Produto>() {
                    ...
                    @Override
                    public void quandoFalha(String erro) {
                        mostraErro(MENSAGEM_ERRO_INCLUSAO);
                    }
                });
    }
